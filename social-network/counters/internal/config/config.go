...
type Config struct {
	ServiceName           string `envconfig:"SERVICE_NAME" default:"social-network-counter"`
	HTTPServerListenPort  int    `envconfig:"HTTP_SERVER_LISTEN_PORT" required:"true"`
	DebugServerListenPort int    `envconfig:"DEBUG_SERVER_LISTEN_PORT" required:"true"`
	Debug                 bool   `envconfig:"DEBUG" default:"false"`

	Log      Log
	ValkeyDB ValkeyDB `envconfig:"VALKEY_DB"`
